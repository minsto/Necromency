                                ...
                                Optional.ofNullable(minecraftserver.getLevel(globalpos.dimension()))
                                    ...
                                    .flatMap(
                                        p_396688_ -> BuiltInRegistries.VILLAGER_PROFESSION
                                            .listElements()
                                            .filter(p_396690_ -> p_396690_.value().heldJobSite().test((Holder<PoiType>)p_396688_))
                                            .findFirst()
                                    )
                                    .ifPresent(p_396687_ -> {
                                        p_258310_.setVillagerData(p_258310_.getVillagerData().withProfession(p_396687_));
